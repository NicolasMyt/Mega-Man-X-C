...
function preload(){
 ...
 //Carregar Animações
 XIdle = loadImage("XSprites/Idle/XIdle1.png");
 XIdle.frameDelay = 5
 XIdle.playing = true;
 XIdle = loadJSON('XSprites/SpriteSheet/XIdle.json')
 XIdle = 0
 ...
 XJump.looping = true;
 XJumpJSON = loadJSON('XSprites/SpriteSheet/Jump.json')
 XJumpImage = loadImage('XSprites/SpriteSheet/Jump.png')
 XJumpArray = []
...
function setup() {
  ...
  var AnimationsPositions = XJumpJSON.frames

  for (i = 0;i < AnimationsPositions.lenght; i ++){
    XJumpArray.push( XJumpImage.get(AnimationsPositions.x,AnimationsPositions.y,AnimationsPositions.w,AnimationsPositions.h) )
  }
